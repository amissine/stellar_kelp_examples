...
exe '2resize ' . ((&lines * 22 + 24) / 48)
tabnext
edit ~/go/src/github.com/amissine/stellar_kelp_examples/fund_source_account.run
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
tabnext 1
set stal=1
badd +0 ~/go/src/github.com/amissine/stellar_kelp_examples/progress.saved
...
badd +15 ~/go/src/github.com/amissine/stellar_kelp_examples/cfg/trader.cfg.src
badd +1 ~/go/src/github.com/amissine/stellar_kelp_examples/add_trader_account.run
badd +0 ~/go/src/github.com/amissine/stellar_kelp_examples/add_source_account.run
